...
module.exports = {
  ...
  "components": [
    ...
    await interaction.reply("<:check:1502740417370787881> **Succesfully** logged training.")
        }
    if (sub === "ridealong") {
        const cadet = interaction.options.getUser("cadet");
        const result = interaction.options.getString("result");
  ...
  "components": [
    ...
    await interaction.reply({content: "<:check:1502740417370787881> **Successfully** logged ride along."})
    }
    }
}